                ...
                <NavigationMenuItem>
                    ...
                    <NavigationMenuContent>
                        <ul className='grid gap-3 p-6 md:w-[400px] ld:w-[500px] lg: grid-cols[.75fr_1fr]'>
                            <li>
                                <span className='w-full h-full select-none flex flex-col justify-end rounded-md p-6 no-underline bg-gradient-to-b from-muted/50 to-muted focus:shadow-md'>
                                    Welcome
                                </span>
                            </li>
                            <ListItem href='#' title='Introduction'>Re-usable components built using Radix UI and Tailwind CSS.</ListItem>
                            <ListItem href='#' title='Installation'>How to install dependencies and structure your app.</ListItem>
                            <ListItem href='#' title='Typography'>Styles for headings, paragraphs, lists...etc</ListItem>
                        </ul>
                    </NavigationMenuContent>
                </NavigationMenuItem>
                <NavigationMenuItem>
